...
irr::scene::IQuadSceneNode::
IQuadSceneNode(irr::scene::ISceneNode* parent, irr::scene::ISceneManager* mgr, irr::s32 id) : irr::scene::ISceneNode(
    parent, mgr)
{
...
irr::scene::IQuadSceneNode::~IQuadSceneNode() { delete Buffer; }
...
irr::video::SMaterial& irr::scene::IQuadSceneNode::getMaterial(irr::u32 num) { return Material; }

irr::u32 irr::scene::IQuadSceneNode::getMaterialCount() const { return 1; }
